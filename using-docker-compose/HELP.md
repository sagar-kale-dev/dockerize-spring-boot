...
* The original package name 'co.in.sagarkale.docker-compose-spring-boot' is invalid and this project uses 'co.in.sagarkale.docker_compose_spring_boot' instead.
